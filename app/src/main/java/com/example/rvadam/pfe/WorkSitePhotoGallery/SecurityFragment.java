...
public class SecurityFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_security_photos, container, false);

        for (SecurityPhotoTypes type : SecurityPhotoTypes.values()) {
            RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getActivity(), 2);
            List<SpacePhoto> listToDisplay = ListOfPhotosSingletonManager.getListOfPhotosByCategoryAndType(PhotoCategories.SECURITY, String.valueOf(type));
