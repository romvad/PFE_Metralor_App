package com.example.rvadam.pfe.TestLoginWithMSAL;
...
public class LoginActivity extends AppCompatActivity {
    ...
    final static String CLIENT_ID = "28e52f7c-c97f-4296-ba95-ee04856a60f4";
    ...
    Button linkToOneDriveManagement;
...
*/
    ...
    /* Let's do an interactive request */
        ...
        //TEST ONEDRIVE /////////////////////////////
        linkToOneDriveManagement= (Button)findViewById(R.id.buttonToOneDrivePickSave);

        linkToOneDriveManagement.setOnClickListener(new View.OnClickListener() {
            @Override
...
// getAuthInteractiveCallback() - callback defined to handle acquireToken() case
    ...
    */
    ...
    private void updateSuccessUI() {
        ...
        linkToOneDriveManagement.setVisibility(View.VISIBLE);
    ...
    */
    private void onCallGraphClicked() {
        Log.i(TAG,"onCallGraphClicked(k call");
